...
export function PreviewFrame() {
  ...
  if (error) {
    if (error === "firstLoad") {
      return (
        <div className="h-full flex items-center justify-center p-8 bg-gradient-to-br from-violet-50 via-indigo-50 to-slate-50">
          <div className="text-center max-w-md">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-600 mb-5 shadow-lg shadow-violet-200">
              <svg
    ...
    return (
      <div className="h-full flex items-center justify-center p-8 bg-gradient-to-br from-violet-50 via-indigo-50 to-slate-50">
        <div className="text-center max-w-md">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-rose-500 to-orange-500 mb-5 shadow-lg shadow-rose-200">
